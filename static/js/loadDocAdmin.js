...
function loadDocAdmin(ide){
  ...
  $.ajax({url: "http://188.226.149.94/infoAdmin/"+resa_id, success: function(result){
    ...
    success: function(resa){
      ...
      $("#resaUniAdminContentLow").append("<p><i>'"+resa[0].comment+"'</i></p>");
      $("#resaUniFootAdmin").append("<tr>");
      $("#resaUniFootAdmin").append("<td><b>TOTAL</b></td>");
      $("#resaUniFootAdmin").append("<td><b>"+resa[0].total+"€"+"</b></td>");
      $("#resaUniFootAdmin").append("</tr>");
      ...
      if (resa[0].status =="1") {
      $("#status").html("<em class='fa fa-square-o fa-4x'></em>")
      ...
      if (resa[0].status =="2") {
      $("#status").html("<em class='fa fa-check-square-o fa-4x text-success'></em>")
      ...
      if (resa[0].status =="3") {
      $("#status").html("<em class='fa fa-times fa-4x'></em>")
      $("#resaUniAdminContentRight").append("Reservation refused</p>");
      $("#confirmResa").show();
      $("#deleteResa").hide();
      };
      if (resa[0].status =="4") {
      $("#status").html("<em class='fa fa-trash fa-4x'></em>")
      ...
      if (resa[0].status =="5") {
      $("#status").html("<em class='fa fa-archive fa-4x'></em>")
